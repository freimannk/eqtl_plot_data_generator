...
include { generate_plot_leafcutter_data } from  '../modules/generate_plot_data'
...
workflow recap_plot_leafcutter {
    ...
    groupped_ge_dir_paths = generate_plot_leafcutter_data.out.plot_data_directories.groupTuple(by: [0,1,2])
