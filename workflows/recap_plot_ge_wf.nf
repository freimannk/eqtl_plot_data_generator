...
include { generate_plot_ge_data } from  '../modules/generate_plot_data'
...
workflow recap_plot_ge {
    ...
    groupped_ge_dir_paths = generate_plot_ge_data.out.plot_data_directories.groupTuple(by: [0,1,2])
