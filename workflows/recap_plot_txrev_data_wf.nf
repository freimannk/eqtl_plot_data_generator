...
include { generate_plot_txrev_data } from  '../modules/generate_plot_data'
...
workflow recap_txrev_plot_data {
    take: 
    study_tsv_inputs_ch
    ...
    groupped_ge_dir_paths = generate_plot_txrev_data.out.plot_data_directories.groupTuple(by: [0,1,2])
