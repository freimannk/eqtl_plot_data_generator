...
include { generate_plot_tx_data } from  '../modules/generate_plot_data'
...
workflow recap_plot_tx {
    ...
    groupped_ge_dir_paths = generate_plot_tx_data.out.plot_data_directories.groupTuple(by: [0,1,2])
